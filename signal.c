...
int main()
{
    ...
    N_END=17;       /* How many SN would you actually like to USE? DEFAULT=208, but choice doesntmatter */
    ...
    //Chao: No old file yet, so commenting it out...
    ...
    */
    ...
    /* } */
    /* fclose(ifp); */
    //Chao: I'm changing to path here
